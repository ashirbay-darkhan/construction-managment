          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link to="/today"
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Today tasks</span>
                <span
                  className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">1</span>
              </Link>
            </li>
            <li>
              <Link to="/inbox"
            ...
            <li>
              <a href="#"
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Next 7 day</span>
              </a>
            </li>
            <li>
              <a href="#"
